                ...
                <div className='card' >
                    ...
                    <div className='card-body' >
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input onChange={handleChange} name='title' value={courseDatas.title} type="text" readonly class="form-control" id="staticEmail" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="staticEmail"  class="col-sm-2 col-form-label"> Description </label>
                            <div class="col-sm-10">
                                <input onChange={handleChange} name='description' value={courseDatas.description} type="text" readonly class="form-control" id="staticEmail" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input onChange={handleChange} name='techs'  value={courseDatas.techs} type="text" readonly class="form-control" placeholder='python,django,javascript,react' id="staticEmail" />
                            </div>
                        </div>
